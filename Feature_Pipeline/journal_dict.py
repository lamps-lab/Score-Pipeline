...
output2.to_pickle('/data/xwei/score_pileline_app/Feature_Pipeline/journal_dictionary.pkl')

#Coverting to pickle and reading it
journal_dict = pd.read_pickle('/data/xwei/score_pileline_app/Feature_Pipeline/journal_dictionary.pkl')
