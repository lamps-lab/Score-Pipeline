...
try:
    tokenizer = AutoTokenizer.from_pretrained('Feature_Pipeline/tamu_features/rec_model')
    model = AutoModelForSequenceClassification.from_pretrained('Feature_Pipeline/tamu_features/rec_model')
    print("--- Downstream Model Loaded Successfully --- ")
