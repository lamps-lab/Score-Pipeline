from Feature_Pipeline.tamu_features.crawler import PaperInfoCrawler
from Feature_Pipeline.tamu_features.data_processor import DataProcessor
#from Feature_Pipeline.tamu_features import PaperInfoCrawler, DataProcessor
import pdb

# TODO: Path
VENUE_METADATA_FILE = r'Feature_Pipeline/tamu_features/venue_meta/all_venues.csv'
TRAINING_DIR = r'Feature_Pipeline/tamu_features/training_data/'
